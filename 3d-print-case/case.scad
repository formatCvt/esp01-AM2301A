...
pcbLength           = 50; // front to back (X axis)
pcbWidth            = 70; // side to side (Y axis)
pcbThickness        = 1.6; 
...
[
  [3,2.5,
    ...
    3.0, //insertDiameter
    8, //outsideDiameter
    yappCoordPCB, yappFrontLeft,yappSelfThreading],
  [3,2.5,
    0, //StandHeight
    3.1, //screwDiameter
    5.5, //screwHeadDiameter
    3.0, //insertDiameter
    8, //outsideDiameter
    yappCoordPCB, yappFrontRight, yappSelfThreading],
  [3,2.5,
    0, //StandHeight
    3.1, //screwDiameter
    5.5, //screwHeadDiameter
    3.0, //insertDiameter
    8, //outsideDiameter
    yappCoordPCB, yappBackRight, yappSelfThreading],
  [3,2.5,
    0, //StandHeight
    3.1, //screwDiameter
    5.5, //screwHeadDiameter
    3.0, //insertDiameter
    8, //outsideDiameter
    yappCoordPCB, yappBackLeft, yappSelfThreading],
];
...
cutoutsLeft =   
[
    [(pcbLength("Main")/2),(lidPlaneThickness + lidWallHeight + baseWallHeight + basePlaneThickness)/3, 1, 4,  4, yappCircle, yappCenter],

];

cutoutsRight =  
[
    [(pcbLength("Main")/2),5, 5, 2,  0.3, yappRoundedRect, yappCenter],
];
...
[
   /*[0,           3.5, 15, 3, yappLeft]
  ,[shellLength-15, 3.5, 15, 3, yappLeft]*/
];
//===================================================================
//  *** Light Tubes ***
//-------------------------------------------------------------------
